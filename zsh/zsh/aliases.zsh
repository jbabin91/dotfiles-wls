...
# Exa
alias l='exa -as filename --icons --group-directories-first'
alias ls='exa --icons --group-directories-first'
alias la='exa -as filename --icons --group-directories-first'
alias ll='exa -lhas filename --icons --group-directories-first'
alias lt='exa -laT --sort filename --ignore-glob "node_modules|dotbot|.git" --icons --group-directories-first'
